  ...
  return (
    <div className={styles.homeWrapper}>
      ...
      <div className={styles.topRow}>
        ...
        <div className={styles.welcomeText}>
          Welcome, <span>{currentUser?.first_name || "Guest"}</span>
        </div>
      </div>
            ...
            >
              <div className={styles.userInfo}>
                ...
                <div className={styles.iconWrapper}>
                  ...
                  <span className={styles.anonymousLabel}>Anonymous</span>
                </div>
                ...
                <div className={styles.questionContainer}>
                  ...
                  <div className={styles.questionContent}>
                    <span className={styles.questionPreviewFull}>
                      {q.title?.length > 50
                        ? q.title.slice(0, 50) + "..."
                        : q.title}
                    </span>
                    <p className={styles.questionDescription}>{q.content}</p>
                  </div>
                </div>
              </div>
            </div>
